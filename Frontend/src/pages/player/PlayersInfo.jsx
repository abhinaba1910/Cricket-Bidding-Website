...
//         setPlayers(res.data);
//       } catch (err) {
//         toast.error("Failed to fetch players", err);
//       }
//     };
//     fetchPlayers();
//   }, []);
...
//                         Base Price: ₹
//                         {selectedPlayer.basePrice?.toLocaleString() || 0}
//                       </p>
//                     </div>
//                   </div>
//                 </div>
...
//                     Transfer Price: ₹
//                     {Number(transferPrice || 0).toLocaleString()}
//                   </p>
//                 </div>
//               )}
//             </div>
...
export default function PlayersInfo() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-3 md:p-6 lg:p-8 max-md:px-0 max-md:pb-14">
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between mb-6 gap-4">
        <h1 className="text-xl md:text-2xl font-bold text-gray-900 px-3 md:px-0">Players</h1>
