...
const Dashboard = () => {
  ...
  useEffect(() => {
    ...
    // Example mock data structure (comment out in production)
    /*
    setAuctions([
      { id: '1', name: 'Mock Auction 1', status: 'live', startTime: '2025-05-20T10:00:00Z', endTime: '2025-05-20T12:00:00Z' },
      { id: '2', name: 'Mock Auction 2', status: 'upcoming', startTime: '2025-06-01T09:00:00Z', endTime: '2025-06-01T11:00:00Z' },
    ])
