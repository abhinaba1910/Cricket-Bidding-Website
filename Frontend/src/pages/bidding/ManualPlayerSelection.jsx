...
//         const updatedQueue = [...currentQueue, ...newQueuePlayers];

//         console.log("UPDATED", updatedQueue);
//         await api.post(`/set-manual-queue/${id}`, {
//           newPlayers: newQueuePlayers,
//           existingQueue: currentQueue,
//         });
//         console.log("NEW", newQueuePlayers);
...
//       alert("Failed to process player selection. Please try again.");
//     }
//   };
